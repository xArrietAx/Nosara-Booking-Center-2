...
export function Hero() {
    return (
      <section>
        <div
          className="relative pt-[100px] pb-[190px] text-white bg-cover bg-no-repeat bg-center"
          style={{
            backgroundImage: `url('${content.hero["bg-img"]}')`,
          }}
        >
          ...
          <div className="container relative z-10 flex flex-col items-center gap-5 text-center">
            ...
            <h1 className="heading-1">{content.hero.title}</h1>
