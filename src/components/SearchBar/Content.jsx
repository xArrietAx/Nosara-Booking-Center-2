...
export function Content({ children, handleSubmit }) {
    return <form noValidate onSubmit={handleSubmit} className="grid items-center w-full py-5 border border-border rounded-2xl bg-white sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
    {children}
